const Webtoons = [
  ...
  },
  {
    ...
    episode: `심한 천식질환으로 시골로 이사오게 된 11살 소년 호준이.
              어느 날 밤.
              푸른 눈을 가진 하얗고 포동포동한 털북숭이가 호준이 앞에 나타나 경고한다.
              "우리는 후라이족입니다! 인간은 이 집을 떠나십시오!"`,
    tags: ["#감성", "#성장물", "#힐링", "#무해한", "#동물", "#러블리"],
  },
  {
    id: 2,
    posterImg:
    ...
    title: "개집사",
    author: "고추참치",
    episode: `출근도 퇴근도 없는 똑같은 일상의 작가…눈치채지 못한 사이 작가의 삶에 다이나믹한 소재를 주는 두 존재가 있었는데…!
              작지만 자존감 만큼은 하늘 같은 말티즈, 덩칫값못하는 진도 믹스 아가씨들을 모시는 집사&작가의 삶`,
    tags: ["#일상", "#일상개그힐링", "#가벼운", "#무해한", "#동물", "#힐링"],
  },
  {
    id: 3,
    posterImg:
    ...
    author: "일인분",
    episode: `미각을 잃은 스타 셰프 강현은 사람들의 눈을 피해 한적한 시골로 숨는다.
              시골 할아버지 집에서 발견한 이세계로 이어진 통로
              기왕 도망 온 김에 이세계에서 유유자적 캠핑 라이프를 즐기려고 하는데…
              자꾸만 강현에게 관심을 가지는 이세계 사람들과연 강현은 진짜 힐링을 찾을 수 있을 것인가?`,
    tags: ["#판타지", "#감성적인", "#일상", "#이세계요리", "#힐링", "#가벼운"],
  },
  {
    id: 4,
    posterImg:
